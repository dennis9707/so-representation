...
#model_name = 'dennishe97/longformer-code-mlm-v3'
#model_name = 'dennishe97/longformer-code-cl'
model_name = 'allenai/longformer-base-4096'
word_embedding_model = models.Transformer(model_name, max_seq_length=100, model_args={'attention_window':40})
#word_embedding_model = models.Transformer(model_name, max_seq_length=100)
pooling_model = models.Pooling(word_embedding_model.get_word_embedding_dimension())
model = SentenceTransformer(modules=[word_embedding_model, pooling_model])
'''
model_name = './SBRT_output/former_longformer_base_bi-encoder-min_5_max_15_ir_15_5k_distilroberta-base-2022-04-20_10-23-29/'
...
for p in [15]:
  for n in [15]:
    ...
    import json 
    model_save_path = './SBRT_output/original_allenai_longformer_base_bi-encoder-min_5_max_'+p+'_ir_'+n+'_5k_distilroberta-base'+'-'+datetime.now().strftime("%Y-%m-%d_%H-%M-%S")
    corpus = {}
    ...
    ir_evaluator = evaluation.InformationRetrievalEvaluator(dev_queries, corpus, dev_rel_docs, name='longformer-train_eval')
