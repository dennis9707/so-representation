...
Fine-tuning (or training from scratch) the library models for language modeling on a text dataset for
...
You can find more information about the differences between those
